...
import com.server.server.Util.WebUtil;
...
public class AjaxLoginProcessFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static Logger logger = LoggerFactory.getLogger(AjaxLoginProcessFilter.class);
    ...
    public AjaxLoginProcessFilter(String defaultFilterProcessesUrl, AuthenticationSuccessHandler successHandler,
